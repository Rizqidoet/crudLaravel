                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="px-4 py-5 md:px-16 bg-white space-y-6 sm:p-6">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <table class="md:w-full" id="dynamicAddRemoveIngredient">
                                                ...
                                                <tr>
                                                    <td>
                                                    <input type="text" class="hidden" name="hiddenInputIngredient[{{$ingredient->id }}]" id="{{ $ingredient->id }}" value="{{ $ingredient->ingredient_name }}"/>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </table>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <table class="md:w-full" id="dynamicAddRemoveStepCooking">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="mt-1 flex rounded-md shadow-sm">
                                                            ...
                                                            <input type="text" value="{{ $cooking_step->stepcooking_name }}" name="moreFieldsStepCooking[{{$cooking_step->id }}]" id="{{ $cooking_step->id }}" placeholder="Jelaskan cara memasaknya" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                                                            />
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                    <input type="text" class="hidden" name="hiddenInputStepCooking[{{$cooking_step->id }}]" id="{{ $cooking_step->id }}" value="{{ $cooking_step->stepcooking_name }}"/>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </table>
                            ...
                            <!-- <div class="px-4 py-3 text-center sm:px-6">
                                ...
                                <a href="{{ route('recipes.index') }}" :="request()->routeIs('recipes/index')" class="md:ml-5 bg-white py-2.5 mt-2 md:px-20 px-10 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:no-underline hover:text-red-600">
                                    Back to menu
                                </a>
                            </div> -->
                                ...
                                <div class="md:w-full pb-16 flex row mx-auto justify-center items-center">
                                    <div class="col text-right">
                                        <div class="dropdownnih inline-block relative">
                                            <button type="submit" class="bg-indigo-600 text-white py-2 px-20 rounded-md inline-flex items-center">
                                                <span class="mr-1">Update as</span>
                                            ...
                                            <ul class="dropdown-menunih absolute hidden pt-1 ml-10 text-left">
                                                ...
                                                <li class="bg-gray-100">
                                                    <a href="#" class="rounded-b hover:bg-indigo-600 hover:text-white text-indigo-600 py-2 px-10 block whitespace-no-wrap no-underline hover:no-underline" href="#">
                                                        Publish
                                                    </a>
                                                </li>
                                            </ul>
