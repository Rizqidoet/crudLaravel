                                ...
                                <div class="p-4 md:w-1/3">
                                    <div class="flex rounded-lg h-full bg-gray-100 flex-col px-2">
                                        ...
                                        <div class="flex items-center px-2">
                                            ...
                                            <h2 class="hidden text-gray-900 text-xs font-semibold title-font">
                                                {{ $recipe->id }} 
                                            </h2>
                                            <h2 class="text-gray-900 text-xs font-semibold title-font">
                                                {{ $recipe->title }} 
                                            </h2>
                                        </div>
                                        <div class="flex-grow ml-3 mb-3">
                                            <a href="{{ route('recipesFront.edit', $recipe->id) }}" class="mt-1 text-xs text-indigo-500 inline-flex items-center">
                                                See detail's
